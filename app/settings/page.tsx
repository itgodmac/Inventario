    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-background">
            <div className="max-w-3xl mx-auto py-8 px-4">
                ...
                {/* Warning */}
                <div className="mb-6 bg-orange-50 dark:bg-orange-900/20 border-l-4 border-orange-400 p-4 rounded-r-lg">
                ...
                <div className="space-y-4 mb-8">
                    {settingsConfig.map(config => {
                        ...
                        return (
                            <div key={config.key} className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-5 shadow-sm">
