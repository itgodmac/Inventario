...
export default function InventoryClient({ initialProducts }: InventoryClientProps) {
    ...
    return (
        <main ref={container} className="min-h-screen bg-[#F2F2F7] pb-24 font-sans selection:bg-blue-100 selection:text-blue-900">
            {/* Search, Filter, and Grid UI from previous file... */}
                    ...
                    <div className="relative group w-full md:max-w-md z-20">
                        ...
                        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
                            <div className="relative">
                                ...
                                {isSortOpen && (
                                    <div className="absolute right-0 top-full mt-2 w-48 bg-white/90 backdrop-blur-xl rounded-xl shadow-xl border border-[#3C3C43]/10 p-1 animate-in fade-in zoom-in-95 duration-100 transform origin-top-right">
            ...
            {/* Pagination Footer */}
            <div className="max-w-[1400px] mx-auto px-6 py-6 mt-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[#3C3C43]/5">
            ...
            <button
                ...
                className="fixed bottom-8 right-8 w-14 h-14 bg-[#007AFF] text-white rounded-full shadow-lg shadow-blue-500/30 flex items-center justify-center hover:bg-[#0056b3] transition-all hover:scale-110 active:scale-95 z-50"
                title="Scan Barcode"
            >
                {/* SVG Icon */}
